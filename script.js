...
const MESSAGES = [
  {
    ...
    from: "Archisman",
    x: "3%", y: "4%", w: "26%", h: "13.8%", r: "-4deg", type: "plain"
  },
  {
    ...
    from: "Mayank",
    x: "31%", y: "4%", w: "18%", h: "15.4%", r: "-3deg", bg: "#ffdcd5", tape: "rgba(255, 181, 165, .75)"
  },
  {
    text: "Happy Birthday, Dhananjay! Hope the birthday goes as perfectly as your drawings!",
    from: "^^ Nirav",
    x: "5%", y: "15%", w: "24%", h: "13.8%", r: "-2deg", bg: "#dceeff", tape: "rgba(193, 222, 255, .75)"
  },
  {
    ...
    from: "~~Simran",
    x: "34%", y: "31%", w: "20%", h: "14.2%", r: "3deg", type: "plain"
  },
  {
    ...
    from: "-RJ",
    x: "7%", y: "35%", w: "24%", h: "12.7%", r: "-3deg", bg: "#fff0c7", tape: "rgba(255, 215, 130, .55)"
  },
  {
    ...
    from: "Niket",
    x: "32%", y: "66%", w: "24%", h: "11.9%", r: "-2deg", bg: "#ffd9df", tape: "rgba(255, 165, 190, .55)"
  },
  {
    ...
    from: "Rishabh",
    x: "58%", y: "8%", w: "26%", h: "13.8%", r: "3deg", type: "plain"
  },
  {
    ...
    from: "RUTVI",
    x: "82%", y: "3%", w: "17%", h: "17%", r: "7deg", bg: "#eee2ff", tape: "rgba(210, 192, 255, .60)"
  },
  {
    text: "Happy birthday Dhananjay! Have a great year ahead, and let’s meet and play more Catan by (one of) your next birthday(s)",
    from: "Prithvi",
    x: "7.5%", y: "79%", w: "20%", h: "11.9%", r: "2.5deg", bg: "rgba(240, 165, 233, 0.66)", tape: "rgba(255, 220, 120, .60)"
  },
  {
    ...
    from: "Anugya",
    x: "81%", y: "37%", w: "18%", h: "13.3%", r: "2deg", type: "plain"
  },
  {
    ...
    from: "Kulchi",
    x: "55%", y: "66%", w: "19%", h: "12.4%", r: "-2deg", bg: "#fffaf3", tape: "rgba(167, 218, 255, .65)"
  },
  {
    ...
    from: "Akshat",
    x: "73%", y: "63%", w: "16%", h: "13.3%", r: "3deg", type: "heart-note"
  },
  {
    ...
    from: "Shaurya",
    x: "84%", y: "70%", w: "16%", h: "12.8%", r: "4deg", bg: "#ddf3e6", tape: "rgba(151, 221, 184, .65)"
  },
  {
